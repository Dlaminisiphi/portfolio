...
import Weather from '../assets/weather.png';  // Fixed the import
...
<div name='work' className='w-full md:h-screen text-gray-300 bg-[#0a192f]'>
  ...
  <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
    ...
    <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
      ...
      <div style={{backgroundImage: `url(${Youtube})`}} className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center text-center items-center mx-auto content-div'>
